...
const FilterSidebar = ({ filterState, setFilterState, onClose }) => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      {filterState.submenu ? (
        // Submenu View (e.g. SIZE)
        <div className="flex-1 overflow-y-auto pb-[64px] px-4">
          ...
          <div className="flex-1 overflow-y-auto space-y-4 pb-[64px]">
              ...
              >
                ...
                <span className="">
                  {isPriceOpen ? (
                    ...
                    <img src={plus} alt="add" className="h-6 cursor-pointer" />
                  )}
                </span>
              </div>
            ...
            {sections.map((section, idx) => (
              <div
                ...
                onClick={() => setFilterState({ open: true, submenu: section })}
              >
                {section}
